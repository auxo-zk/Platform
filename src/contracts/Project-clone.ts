...
export class RollupProjectOutput extends Struct({
...
export const RollupProject = ZkProgram({
    name: 'RollupProject',
...
export class RollupProjectProof extends ZkProgram.Proof(RollupProject) {}
