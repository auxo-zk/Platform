...
export const INSTANCE_LIMITS = {
    ...
    PROJECT_MEMBER_TREE_SIZE: 2 ** 1,
    ZKAPP_ADDRESS_TREE_SIZE: 2 ** 4,
    CAMPAIGN_TREE_SIZE: 2 ** 5,
    FUNDING_TREE_SIZE: Constants.ENCRYPTION_LIMITS.SUBMISSION,
    PARTICIPATION_TREE_SIZE: 2 ** 5 * 2 ** 5,
    PARTICIPATION_SLOT_TREE_SIZE: Constants.ENCRYPTION_LIMITS.DIMENSION,
    TREASURY_MANAGER_TREE_SIZE: 2 ** 5 * Constants.ENCRYPTION_LIMITS.DIMENSION,
    CLAIMED_INDEX_TREE_SIZE: 2 ** 5 * Constants.ENCRYPTION_LIMITS.DIMENSION,
